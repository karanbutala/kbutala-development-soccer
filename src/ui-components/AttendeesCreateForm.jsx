...
import { createAttendees } from "../graphql/mutations";
export default function AttendeesCreateForm(props) {
  ...
  const resetStateValues = () => {
    setAttendeeNo(initialValues.attendeeNo);
    setAttendeeFirstName(initialValues.attendeeFirstName);
    setAttendeeLastName(initialValues.attendeeLastName);
    setAttendeeContact(initialValues.attendeeContact);
    setRegistrationTimestamp(initialValues.registrationTimestamp);
    setErrors({});
  };
  const validations = {
